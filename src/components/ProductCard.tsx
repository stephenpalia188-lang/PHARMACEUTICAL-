...
import { ShoppingCart, Check, AlertCircle, Plus, Eye, ShieldAlert } from 'lucide-react';
      ...
      <div>
        ...
        <div className="relative w-full h-44 rounded-xl overflow-hidden bg-slate-100 mb-3.5">
          <img
            ...
            onError={(e) => {
              // Safe fallback image
              (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1471864190281-a93a3070b6de?w=500&auto=format&fit=crop&q=80';
            }}
          />
